   ...
   // echo $usuario->verificar($logina, $clavehash);
	...
	if (isset($fetch)) {	
		...
		//determinamos lo accesos al usuario
			...
			in_array(8, $valores)?$_SESSION['TEMP']=1:$_SESSION['TEMP']=0;
...
case 'regevento':			
		...
		// $rspta=$usuario->regevento(0,$_GET["cedula"],$_GET["nombres"],$_GET["apellidos"],$_GET["cargo"],$_GET["telefono"],$_GET["correo"],$_GET["institucion"],$_GET["ciudad"],$_GET["genero"],$_GET["etnia"]);
		   $rspta=$usuario->regevento(0,$_GET["cedula"],$_GET["nombres"],$_GET["apellidos"],"",$_GET["telefono"],$_GET["correo"],"",$_GET["ciudad"],$_GET["genero"],$_GET["edad"]);
		 $row = $rspta->fetch_row();
		//    echo $rspta;
		echo $row[0];
...
case 'validareg':			
		 ...
		 $rspta=$usuario->regevento(1,$_GET["cedula"],"","","","","","","","","");
