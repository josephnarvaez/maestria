...
while ($reg=$rspta->fetch_object()) {
	if ($reg->carrera==12){
		...
		$pdf->setx($tope+53);
		$pdf->SetFont('Arial','B',5);
		$pdf->MultiCell(45,2,utf8_decode("GESTOR CENTRO DE IDIOMAS"),'LR','C',0);
		$pdf->setx($tope+53);
...
$pdf->MultiCell(45,15,utf8_decode(""),'LR','C',0);
$pdf->setx(120);
$pdf->MultiCell(45,4,utf8_decode("Ing. Christian Montalvo"),'LR','C',0);
$pdf->setx(120);
$pdf->SetFont('Arial','B',5);
$pdf->MultiCell(45,4,utf8_decode("Coordinador Academico"),'LBR','C',0);
$tope=$pdf->getx();
