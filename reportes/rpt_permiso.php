...
$pdf->MultiCell(40,6,"FECHA",1,'L',1);
$pdf->setXy($x+40,$y);	
...
$x=$pdf->getx();
$y=$pdf->gety();
$pdf->MultiCell(160,6,"COORDINACION / GERENCIA / PROYECTO",'LR','L',0);
$pdf->MultiCell(160,6,"COORDINACION ZONAL 1",'LR','C',0);
$pdf->setXy($x+160,$y);		
$pdf->MultiCell(100,6,utf8_decode("DIRECCION O UNIDAD"),'LR','L',0);
$pdf->setXY($x+160,$y+6);
$pdf->MultiCell(100,6,utf8_decode("INSTITUTO SUPERIOR TECNOLÓGICO 17 DE JULIO"),'LR','C',0);
...
$pdf->MultiCell(260,4,utf8_decode("Todo formulario de permiso / licencia, deberá ser presentado a la Dirección de Talento Humano con su respectiva justificación, máximo en los tres días posteriores a la emisión del mismo, caso contrario el formulario será nulo y se descontará directamente de vacaciones."),1,'L',1);	
