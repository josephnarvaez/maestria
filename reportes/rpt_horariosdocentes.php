...
//obtengo horarios
$docen=$ingreso->horariosTotales($_GET["periodo"]);
while ($dreg= $docen->fetch_object()) {
...
$pdf->SetFont('Arial','B',14);
 ...
 $docente=$dreg->usu_id;
 $nombredoc=$dreg->usu_nombre; 

$rspta=$ingreso->encabezado(0,$docente);//usu_id
...
$pdf->Ln(6);
//$pdf->Cell(42,6,utf8_decode($pdf->GetY()),1,0,'C',1);	
...
$pdf->SetY($i+51);
$pdf->SetX(13);
$pdf->MultiCell(300,9,'Firma Docente                                                                               Firma Coordinador                                                                                           Firma Vicerrector',0,'L','L',1);
