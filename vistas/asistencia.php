   ...
   <table class="table table-striped" id="asistencias">
                      <thead class="messages-table-header">
                         <tr>
                           ...
                           <th><i class="fa fa-angle-double-right"></i> Hora Entrada</th>
                           <th><i class="fa fa-angle-double-right"></i> Hora Salida</th>
                           <th><i class="fa fa-angle-double-right"></i> Empresa</th>
