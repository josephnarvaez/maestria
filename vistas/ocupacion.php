...
<div class="box-header with-border">
  <h1 class="box-title"><button class="btn btn-warning"><i class="fa fa-calendar-check-o"></i> Porcentaje ocupación por aulas</a></h1>
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Seleccione la Sede:</label>
        <select name="sede" id="sede" class="form-control selectpicker" data-live-search="true" required>    
        <option value="I">Ibarra</option>
  		<option value="Y" selected>Yachay</option>    
            </select>
    </div>
...
<th ><i class="fa fa-clock-o"></i>Aula</th>
...
require 'footer.php'
 ...
 <script src="scripts/ocupacion.js"></script>
