...
<div class="box-header with-border">
  <h1 class="box-title"><button class="btn btn-warning"><i class="fa fa-calendar-check-o"></i> Nro. Teléfonos Usados</a></h1>
  ...
  <form action="" name="formulario" id="formulario" method="POST">
   ...
   <table class="table table-striped" id="asistencias">
                      <thead class="messages-table-header">
						  ...
						  <tr>							 
                           <th><i class="fa fa-angle-double-right"></i>Codigo</th>
                           <th><i class="fa fa-angle-double-right"></i>Docente</th>
                           <th><i class="fa fa-angle-double-right"></i>Nro. Telefonos usados</th>                         
                         </tr>
                      </thead>
                      <tbody>
   				</tbody>
...
require 'footer.php'
 ...
 <script src="scripts/telefonos.js"></script>
